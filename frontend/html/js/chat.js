...
(function () {
  ...
  function renderLayout() {
    ...
    // Right sidebar returned to the previous simple search field layout.
    loadRightSidebar("");
  }
  ...
  window.ChatView = {
    mount: async function () { renderLayout(); applyPrefs(); connectWS(); setupIdleWatcher(); bindFocusClear(); bindPlainMessageCopy(); loadPermissions(); loadMissedCallsUnread(); await loadChats(); if ((location.hash || "").indexOf("calls=1") >= 0) setTimeout(openCallsModal, 200); },
