...
class ManualContact(Base):
    """Text-only address book entry created manually by an administrator.

    It is intentionally NOT an application user: it must appear only in the
    Contact Book and must not be available in chat pickers, right sidebar,
