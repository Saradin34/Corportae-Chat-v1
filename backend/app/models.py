...
class User(Base):
    ...
    # Persistent presence status the user sets manually. Empty = auto (online/away
    # is derived from the live WebSocket connection). Values: "" | dnd | vacation
...
class ChatMember(Base):
    ...
    # Favorite / pinned chat — kept at the top of the user's chat list.
