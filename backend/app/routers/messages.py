...
async def list_messages(
    ...
    # Deleted messages are hidden completely (Telegram-like): no placeholder.
...
async def delete_message(
    ...
    # Hard delete for everyone: remove the DB row so clients do not render any
    # "message deleted" placeholder. Reactions are removed by FK cascade;
